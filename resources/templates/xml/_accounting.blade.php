<cac:{{$node}}>
    ...
    <cac:Party>
        ...
        <cac:PartyTaxScheme>
            ...
            @if($typeDocument->id == '13' || $typeDocument->id == '26'|| $typeDocument->id == '16')                <cbc:CompanyID schemeAgencyID="195" schemeAgencyName="CO, DIAN (Dirección de Impuestos y Aduanas Nacionales)" schemeID="{{preg_replace("/[\r\n|\n|\r]+/", "", $user->company->dv)}}" schemeName="31">{{preg_replace("/[\r\n|\n|\r]+/", "", $user->company->identification_number)}}</cbc:CompanyID>
            @else
