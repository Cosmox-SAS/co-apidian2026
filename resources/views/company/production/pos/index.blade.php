        ...
        <div class="card">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    ...
                    Configuración de Software - Documentos Equivalentes
                </h5>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('company.production.environment.update', [$company->identification_number, 'pos']) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
...
{{-- Paso a Producción POS --}}
@if($environmentStatus['environment_id'] != 1)
<div class="card border mb-4">
    <div class="card-body">
        <h3>Software de Documentos Equivalentes POS</h3>
        <form id="productionForm" method="POST" action="#" autocomplete="off">
            ...
            <button type="submit" class="btn btn-success mt-2" id="btnIniciar">Iniciar Paso a Producción</button>
        </form>
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch(url, {
                    ...
                    .then(data => {
                        ...
                        setStepStatus('step1', 'success', 'Documento POS enviado correctamente');
